...
var adjustModalMaxHeightAndPosition, autoAjustLine, resizeToCover, section_auto_height;

section_auto_height = function() {
  if ($(window).width() > 768) {
    return $('.ah').height($(window).height());
  } else {
    return $('.ah').css({
      height: "auto"
    });
...
resizeToCover = function() {
  ...
  return jQuery(".video-index").scrollTop((jQuery("video").height() - jQuery(window).height()) / 2);
};

autoAjustLine = function() {
  return setTimeout(function() {
    $(".bg-footer-line").addClass("init");
    if ($("main").height() > ($(window).height() + 20)) {
      return $(".bg-footer-line").addClass("toggle");
    } else {
      return $(".bg-footer-line").removeClass("toggle");
    }
  }, 300);
};

adjustModalMaxHeightAndPosition = function() {
  return $(".modal-center").each(function() {
    ...
    $(this).find(".modal-content .img").css({
      "height": function() {
